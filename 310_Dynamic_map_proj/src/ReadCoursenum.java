			...
			for(rowindex=1; rowindex<rows; rowindex++){
			    ...
			    if(row !=null){
			        ...
			        for(columnindex=1; columnindex<cells; columnindex++){
			            ...
			            if(columnindex == 8)
			            	coursenum.setFloating_population(i, rowindex-1, Float.parseFloat(value));
			            else {
			            	if(value.equals("false"))
			            		coursenum.setPeopleNum(i, rowindex-1, columnindex-1, 0.0f);
			            	else
			            		coursenum.setPeopleNum(i, rowindex-1, columnindex-1, Float.parseFloat(value));
			            }
